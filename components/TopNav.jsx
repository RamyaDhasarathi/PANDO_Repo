    ...
    <>
      <header className={styles.wrap}>
          ...
          <div className={styles.actions}>
            {user ? (
              <button 
                ...
                style={{ background: 'none', border: '1px solid #e5e7eb', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}
              >
                <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: '#e11d48', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 'bold' }}>
        ...
        <div className={`${styles.mobileMenu} ${open ? styles.open : ""}`}>
          ...
          {user ? (
            <button onClick={() => { setIsProfileOpen(true); setOpen(false); }} className={styles.mobileTab} style={{ textAlign: 'left', background: 'none', border: 'none', cursor: 'pointer' }}>
